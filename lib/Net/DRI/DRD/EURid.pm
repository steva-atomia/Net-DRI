...
__PACKAGE__->make_exception_for_unavailable_operations(qw/domain_transfer_query domain_transfer_accept domain_transfer_refuse contact_check contact_check_multi contact_transfer contact_transfer_start contact_transfer_stop contact_transfer_query contact_transfer_accept contact_transfer_refuse/);
...
our %CCA2_EU=map { $_ => 1 } qw/AT BE BG CZ CY DE DK ES EE FI FR GR GB HU IE IT LT LU LV MT NL PL PT RO SE SK SI AX GF GI GP MQ RE IS LI NO HR FO GL PF NC PM YT WF SL IC EA AW AN BQ CW SX/;
...
sub transport_protocol_default
{
 ...
 return ('Net::DRI::Transport::Socket',{remote_host=>'epp.registry.tryout.eu',remote_port=>33128,ssl_version=>'TLSv12',ssl_cipher_list=> undef},'Net::DRI::Protocol::EPP::Extensions::EURid',{}) if $type eq 'epp';
