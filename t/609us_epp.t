...
our $E2='</epp>';
our $TRID='<trID><clTRID>coricopat-9978-1002</clTRID><svTRID>54322-XYZ</svTRID></trID>';
...
$dri->add_registry('US');
$dri->target('US')->add_current_profile('p1','test=Net::DRI::Protocol::EPP::Extensions::US',{f_send=>\&mysend,f_recv=>\&myrecv});
